...
export default function Sign(){
    return(
        <>
        <section className="bg-[#FFFF] h-[489px] w-[380px] flex flex-col pt-6 items-center  mb-11  max-w-screen-2xl mx-auto container ">
        ...
        <div className="flex justify-center mt-[15px] space-x-1 text-[11px]">
            ...
            <Link href="/join" className="sm:text-center underline text-[142x] font-semibold hover:text-blue-600">Join us</Link>
            </div>
